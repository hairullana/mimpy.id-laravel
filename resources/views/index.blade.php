                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="slider-content">
                                    ...
                                    <p class="text">WWe collect job vacancies data from various companies and fields of work that you can apply for.</p>
                      ...
                      <div class="row">
                          <div class="col-lg-6">
                              <div class="slider-content">
                                  ...
                                  <p class="text">Helping you in finding specific job vacancies according to your wishes.</p>
                                  <ul class="slider-btn rounded-buttons">
                                      <li><a class="main-btn rounded-one" href="/register">GET STARTED</a></li>
                                  </ul>
                              </div> <!-- slider-content -->
                ...
                <div class="carousel-item">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="slider-content">
                                    <h1 class="title">Find New Employees</h1>
                                    <p class="text">Help you get employees with CV and cover letter features that help you filter out potential employees.</p>
                                    <ul class="slider-btn rounded-buttons">
                                        <li><a class="main-btn rounded-one" href="/register">GET STARTED</a></li>
                                    </ul>
                                </div> <!-- slider-content -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-10">
                    <div class="section-title text-center pb-10">
                        ...
                        <p class="text">The services we provide are</p>
                    </div> <!-- row -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-features mt-40">
                        ...
                        <div class="features-content">
                            <p class="text">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Veritatis ullam officiis laborum hic ab eos maxime doloribus fugit, molestias repellat odio aliquam perspiciatis aspernatur cum cupiditate, cumque temporibus eius officia.</p>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-features mt-40">
                        ...
                        <div class="features-content">
                            <p class="text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt quam deleniti atque aliquam vitae fugiat est unde temporibus necessitatibus minus. Veritatis eius, nisi a magnam molestiae harum rem aliquid provident.</p>
                            <a class="features-btn" href="#">LEARN MORE</a>
                        </div>
                    </div> <!-- single features -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-features mt-40">
                        ...
                        <div class="features-content">
                            <p class="text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Qui aspernatur, rerum voluptatibus nobis nostrum beatae? Placeat laborum, similique laboriosam quidem maiores amet magnam praesentium aliquid, esse minima at consectetur aperiam.</p>
                            <a class="features-btn" href="#">LEARN MORE</a>
                        </div>
                    </div> <!-- single features -->
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="about-image mt-50">
                        <img src="/images/landing-page/about.jpg" alt="about">
                    </div> <!-- faq image -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-contact-info contact-color-1 mt-30 d-flex ">
                            ...
                            <div class="contact-info-content media-body">
                                <p class="text"> Karangasem, Bali</p>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-contact-info contact-color-2 mt-30 d-flex ">
                            ...
                            <div class="contact-info-content media-body">
                                <p class="text">hairullana@outlook.com</p>
                            </div>
                        </div> <!-- single contact info -->
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="single-contact-info contact-color-3 mt-30 d-flex ">
                            ...
                            <div class="contact-info-content media-body">
                                <p class="text">+62 xxx xxxx xxxx</p>
                            </div>
                        </div> <!-- single contact info -->
                    </div>
                </div> <!-- row -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="footer-logo text-center">
                        <a class="mt-30" href="index.html"><img src="/images/landing-page/logo.svg" alt="Logo"></a>
                    </div> <!-- footer logo -->
